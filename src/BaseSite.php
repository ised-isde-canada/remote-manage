...
abstract class BaseSite
{
    ...
    public function backup()
    {
        ...
        if ($success && $this->siteExists) {
            ...
            // The following calculates the minimum required delay based on the starting point within the
            // current minute. The delay should match the value of the terminationGracePeriodSeconds of
            // your cronjob's settings.
            $now = time() % 60;
            if ($this->siteType == 'moodle') {
                // Delay is up to 300 seconds (5 minutes).
                $delay = 300;
            // Note: As of Moodle 3.10, you can query the status of Moodle scheduler thereby potentially
